    ...
    <div>
      ...
      <div>
        <input
          ...
          value={value}
          onChange={onChange}
          className={`block w-full rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-lime-600 sm:text-sm sm:leading-6 ${className}`}
          readOnly={readonly}
        />
        {error && errorMessage && (
